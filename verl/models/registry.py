...
_MODELS = {
    ...
    "Gemma3ForCausalLM": (
        "gemma3",
        ("ParallelGemma3ForCausalLMRmPadPP", "ParallelGemma3ForValueRmPadPP", "ParallelGemma3ForCausalLMRmPad"),
    ),
    "Gemma3ForConditionalGeneration": (
        "gemma3",
        ("ParallelGemma3ForConditionalGenerationRmPadPP", "ParallelGemma3ForValueRmPadPP", "ParallelGemma3ForCausalLMRmPad"),
    ),
    "ApertusForCausalLM": (
        "apertus",
